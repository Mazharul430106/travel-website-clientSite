...
const Navbar = () => {
    ...
    const menuItems = <React.Fragment>
        ...
        <li className='text-[16px]' tabIndex={0}>
            <Link className="justify-between lg:bg-inherit lg:px-2 xl:px-2 px-1">
                Packages
        ...
        <li className='text-[16px]'><Link className='lg:bg-inherit lg:px-2 xl:px-2 px-1' to='/aboutUs'>About Us</Link></li>
        <li className='text-[16px]'><Link className='lg:bg-inherit lg:px-2 xl:px-2 px-1'>Gol</Link></li>
        <li className='text-[16px]'><Link className='lg:bg-inherit lg:px-2 xl:px-2 px-1'>Support</Link></li>
        <li className='xl:ml-28 lg:ml-0 text-[16px]'><Link className='lg:bg-inherit text-[#3282AD] xl:px-2 px-1' to='/login'>Login</Link></li>
        <li className='text-[16px]'><Link className='signUpLast xl:px-2 lg:px-2 px-0 lg:w-[123px] lg:h-[54px] lg:bg-[#056499] lg:text-white lg:flex lg:justify-center pl-4 lg:pl-0' to='/signup'>Sign Up</Link></li>
